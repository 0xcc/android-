...
public class MainActivity2 extends Activity
{
    ...
    { 
        ...
        mAppWidgetHost = new AppWidgetHost(MainActivity2.this, HOST_ID) ;
        ...
        //���AppWidgetManager����
        appWidgetManager = AppWidgetManager.getInstance(MainActivity2.this) ;
    ...
    private void completeAddAppWidget(Intent data){
        ...
        if(appWidgetId == -1){
            Toast.makeText(MainActivity2.this, "��Ӵ���С��������", Toast.LENGTH_SHORT) ;
            return ;
        }
        
        AppWidgetProviderInfo appWidgetProviderInfo = appWidgetManager.getAppWidgetInfo(appWidgetId) ;
        
        AppWidgetHostView hostView = mAppWidgetHost.createView(MainActivity2.this, appWidgetId, appWidgetProviderInfo);
